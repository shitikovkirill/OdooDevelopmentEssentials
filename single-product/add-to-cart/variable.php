<div class="page variable">
    ...
    <form class="variations_form cart" method="post" enctype='multipart/form-data'
        ...
        <div class="action woocommerce_before_variations_form">
        ...
        <?php else : ?>
            ...
            <div class="single_variation_wrap">
                <div class="action woocommerce_before_single_variation">
                    <?php
                    /**
                ...
                <div class="action woocommerce_single_variation">
                    <?php
                    /**
                ...
                <div class="action woocommerce_after_single_variation">
                    <?php
                    /**
        ...
        <?php endif; ?>
        <div class="action woocommerce_after_variations_form">
